...
from deep_rl.component.task import ParallelizedTask, MetaWorld 
...
def metaworld_ppo(name, args, shell_config):
    ...
    task_fn = lambda log_dir: MetaWorld(name=name, env_config_path=env_config_path, log_dir=log_dir)
    ...
    eval_task_fn= lambda log_dir: MetaWorld(name=name, env_config_path=env_config_path, log_dir=log_dir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--shell_config_path', help='shell config', default='./shell_configs/paper_experiments/metaworld.json')                         # File path to your chosen shell.json configuration file. Changing the default here might save you some time.
