...
if __name__ == '__main__':
    ...
    parser.add_argument('--shell_config_path', help='shell config', default='./shell_configs/paper_experiments/compo.json')                         # File path to your chosen shell.json configuration file. Changing the default here might save you some time.
