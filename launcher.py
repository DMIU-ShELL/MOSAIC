...
commands_composuite = [
    ...
    # MIG 3 (0-9)
    ['MIG-e76a2a9b-9867-5f8a-b145-d857cd5ed8e2', "python run_composuite.py 1 39502 -l -d 0.0 --exp_id='comp_agent3'"],

    # MIG 4 (0-10)
    ['MIG-2593b912-5975-58e9-bc3d-495311cee807', "python run_composuite.py 2 39503 -l -d 0.0 --exp_id='comp_agent4'"],

    # MIG 5 (0-11)
    ['MIG-51069529-f343-59c6-bac7-a75648296e7b', "python run_composuite.py 3 39504 -l -d 0.0 --exp_id='comp_agent5'"],

    # MIG 6 (0-12)
    ['MIG-187573d8-7df7-5e5f-87b2-c8b8f73c54e7', "python run_composuite.py 4 39505 -l -d 0.0 --exp_id='comp_agent6'"],
]
