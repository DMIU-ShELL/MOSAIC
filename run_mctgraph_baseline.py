...
from deep_rl.network.network_heads import CategoricalActorCriticNet_SS, GaussianActorCriticNet_SS, CategoricalActorCriticNet_SS_Comp, CategoricalActorCriticNet_CL
from deep_rl.network.network_bodies import FCBody_SS, DummyBody_CL, FCBody_SS_Comp, FCBody_Baseline, DummyBody
...
def mctgraph_ppo(name, args, shell_config):
    ...
    config.network_fn = lambda state_dim, action_dim, label_dim: CategoricalActorCriticNet_CL(\
        ...
        phi_body=FCBody_Baseline(
            state_dim,
            task_label_dim=label_dim,
            hidden_units=(200, 200, 200),
            ),
        actor_body=DummyBody_CL(200),
        critic_body=DummyBody_CL(200))    # 'random' for mask RI. 'linear_comb' for mask LC.
